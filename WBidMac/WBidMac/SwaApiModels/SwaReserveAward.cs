...
{
	public class SwaReserveAward
	{
		public SwaReserveAward()
		{
		}

        public class Embedded
        {
            [JsonProperty("IFLineBaseAuctionReserveAwards")]
            public List<IFLineBaseAuctionReserveAward> IFLineBaseAuctionReserveAwards { get; set; }
        }

        public class IFLineBaseAuctionReserveAward
        {

...
{
	public class SwaJobShareBidAward
	{
		public SwaJobShareBidAward()
		{
		}
        public class Embedded
        {
            [JsonProperty("IFLineBaseAuctionJobShareAwards")]
            public List<IFLineBaseAuctionJobShareAward> IFLineBaseAuctionJobShareAwards { get; set; }
        }

        public class IFLineBaseAuctionJobShareAward
        {
            [JsonProperty("line")]
            ...
            [JsonProperty("jobSharePosition")]
            public int JobSharePosition { get; set; }

...
namespace WBid.WBidiPad.Model
{
    ...
    public class DutyPeriod
    {
        ...
        /// <summary>
        /// Dutyperiod Day sequence number(For the red eye trips, There will be higher number of  dutyperiod count than trip length,
        /// To get the exact duty period date , we can use this property
        /// </summary>
        [ProtoMember(27)]
        public int DutyDaySeqNum { get; set; }

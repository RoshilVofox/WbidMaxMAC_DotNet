...
namespace WBid.WBidiPad.PortableLibrary.BusinessLogic
{
    ...
    public class ObserveCalculateLineProperties
    {
        ...
        private void CalculateWorkBlockDetails(Line line)
        {
            ...
            foreach (var pairing in line.Pairings)
            {
                ...
                {
                    tripPreviousStartTime = trip.DutyPeriods[trip.DutyPeriods.Count - 1].Flights[0].DepTime - trip.BriefTime - (1440 * (trip.PairLength - 1));
                    tripPreviousLandTime = trip.DutyPeriods[trip.DutyPeriods.Count - 1].LandTimeLastLeg - (1440 * (trip.PairLength - 1));
                }
                tripPreviousEndDate = tripEndDate;
                count++;
                backToBack++;
